    ...
    <main id="main">
        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container">
                ...
                <h2>{{ __('Veranstaltungen bearbeiten') }}</h2>
        ...
        <section id="team" class="team">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <form action="{{ route('frontend.veranstaltungen.update', $veranstaltungen->slug) }}" method="post">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ \Carbon\Carbon::parse($veranstaltungen->datum_von)->isoFormat('DD.MM.YYYY HH:mm') }}">
                                        @error('datum_von')
                                    ...
                                    <div class="form-group col-lg-3">
                                        ...
                                        <input type="text"
                                               ...
                                               data-inputmask-inputformat="dd.mm.yyyy HH:MM" data-mask
                                               value="{{ \Carbon\Carbon::parse($veranstaltungen->datum_bis)->isoFormat('DD.MM.YYYY HH:mm') }}">
                                        @error('datum_bis')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Veranstaltung" value="{{ $veranstaltungen->veranstaltung }}">
                                        @error('veranstaltung')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Veranstaltungsort" value="{{ $veranstaltungen->veranstaltungsort }}">
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Veranstalter" value="{{ $veranstaltungen->veranstalter }}">
                                        @error('veranstalter')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Webseite" value="{{ $veranstaltungen->webseite }}">
                                        @error('webseite')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Facebook" value="{{ $veranstaltungen->social_fb }}">
                                        @error('facebook')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="Instagram" value="{{ $veranstaltungen->social_ig }}">
                                        @error('instagram')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group col-lg-4">
                                        ...
                                        <input type="text"
                                               ...
                                               placeholder="twitter" value="{{ $veranstaltungen->social_tw }}">
                                        @error('twitter')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-lg-6">
                                        <input type="text"
                                               ...
                                               placeholder="Eintritt" value="{{ $veranstaltungen->eintritt }}">
                                        @error('eintritt')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
