...
<div class="error">
    <div class="container-fluid">
        <div class="col-xs-12 ground-color text-center">
            ...
            <h2 class="h1">Es tut uns leid! Du hast keine Berechtigung für diesen Seitenzugriff</h2>
            <a href="{{ url('/') }}" class="btn m-3" style="background-color: #7cf12e; border-color: #7cf12e; color: #404040;">Zurück</a>
        </div>
    </div>
</div>
<!-- Error Page -->
